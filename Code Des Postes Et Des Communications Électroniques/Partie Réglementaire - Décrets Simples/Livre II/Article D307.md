...
comptabilisation des coûts d'interconnexion et d'accès ;
...
tarifaire d'interconnexion ou d'accès.
...
l'offre technique et tarifaire d'interconnexion ou d'accès.
...
un délai qu'elle fixe, toute information nécessaire.
...
n'auraient pas été prévues par ladite offre.
...
telle dans la convention d'interconnexion ou d'accès.
