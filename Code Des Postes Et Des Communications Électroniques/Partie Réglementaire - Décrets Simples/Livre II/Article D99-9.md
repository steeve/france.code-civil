...
périodicité ou les préavis correspondants ;

- les procédures à appliquer en cas de proposition d'évolution de l'offre
d'interconnexion et d'accès par l'une des parties ;
...
modalités physiques pour s'y connecter ;

- les modalités de dimensionnement réciproque des équipements afin de maintenir
la qualité de service prévue par la convention ;
