...
- à leurs commutateurs de hiérarchie supérieure ou à une solution technique
équivalente.

L'interconnexion à un commutateur de raccordement d'abonnés permet d'accéder à
tous les abonnés de l'opérateur qui sont accessibles à partir de ce même
commutateur sans transiter par un commutateur de hiérarchie supérieure.
...
l'interconnexion pour des raisons techniques justifiées, ainsi que le calendrier
prévisionnel selon lequel les commutateurs d'abonnés concernés seront ouverts à
l'interconnexion. Toutefois, lorsque l'acheminement du trafic prévisible des
autres opérateurs en provenance ou à destination des abonnés raccordés à un
commutateur de cette liste le justifie, l'opérateur puissant est tenu, sur
demande de l'Autorité de régulation des télécommunications, d'établir pour ce
