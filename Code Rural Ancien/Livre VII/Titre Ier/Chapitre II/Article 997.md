...
a) Un autre jour que le dimanche sous réserve que le jour de repos tombe le
dimanche au moins une fois sur quatre ;

b) Une demi-journée le dimanche avec un repos compensateur d'une journée par
...
deux groupes dont l'un a pour seule fonction de suppléer l'autre pendant le ou
les jours de repos accordés à celui-ci en fin de semaine, sont autorisées à
déroger à l'obligation de donner le repos hebdomadaire le dimanche.
...
La rémunération de ces salariés est majorée d'au moins 50 p. 100 par rapport à
