...
Le taux unitaire annuel de chacune des redevances peut, le cas échéant, intégrer
en tout ou partie les modulations issues d'un précédent plan de performance,
selon des modalités précisées dans le nouveau plan.
...
niveau de trafic ou du niveau d'investissements effectivement réalisés.
