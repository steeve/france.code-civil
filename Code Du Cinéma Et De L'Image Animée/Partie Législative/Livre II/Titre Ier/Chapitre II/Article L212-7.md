...
nouvelle, soit de la transformation d'un immeuble existant ;

2° L'extension d'un établissement de spectacles cinématographiques comportant
plusieurs salles et ayant déjà atteint le seuil de 300 places ou devant le
dépasser par la réalisation du projet à l'exception des extensions représentant
moins de 30 % des places existantes et s'effectuant plus de cinq ans après la
...
et dont les locaux ont cessé d'être exploités pendant deux années consécutives.
