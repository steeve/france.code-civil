...
appartenant à une collectivité ou à un établissement public ;
...
4° Les conditions dans lesquelles une action générale de coordination sur le
...
relative à l'acquisition éventuelle des immeubles par l'Etat ;
...
a) La réparation en nature ou pécuniaire de la moins-value et l'indemnisation
pour plus-value, en cas de travaux exécutés sur un navire réquisitionné ;

b) Le calcul et le paiement de l'indemnité de plus-value, et l'indemnisation de
la moins-value, en cas de travaux exécutés sur un aéronef réquisitionné ;
