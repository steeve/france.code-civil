...
d'inscription au répertoire des personnes physiques ou date et lieu de naissance
du salarié ; c) Adresse ; 3° Mentions relatives à l'emploi et aux cotisations :
a) Nombre d'heures de travail effectuées ; b) Période d'emploi ; c) Salaires
horaire et total nets versés ; d) Option retenue pour le calcul des
contributions et cotisations sociales : assiette forfaitaire ou réelle ; 4° Date
