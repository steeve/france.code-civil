...
ou officinale fait immédiatement l'objet d'une transcription sur un
livre-registre ou d'un enregistrement par tout système approprié.

Chaque transcription ou enregistrement comporte un numéro d'ordre différent et
chronologique ainsi que les mentions suivantes :
...
moyen d'identification du lot d'animaux ;
...
officinale, sa composition est remplacée par le numéro d'ordre de réalisation.
