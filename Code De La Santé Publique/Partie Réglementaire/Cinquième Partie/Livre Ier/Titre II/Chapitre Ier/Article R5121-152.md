...
à un produit mentionné à l'article R. 5121-150 ;
...
médicament ou à mesurer l'efficacité des mesures de gestion des risques ;
...
portant sur un médicament ou un produit ;
...
d'informations de sécurité après l'autorisation de mise sur le marché ;

10° " Plan de gestion des risques " : une description détaillée du système de
gestion des risques défini au 9° ;
