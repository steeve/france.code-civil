...
active et qu'il porte un nom de fantaisie ;
...
d'administration ; un espace est prévu pour indiquer la posologie prescrite ;

7° Le temps d'attente, pour toutes les espèces concernées et pour les
différentes denrées alimentaires concernées même s'il est égal à zéro ;
