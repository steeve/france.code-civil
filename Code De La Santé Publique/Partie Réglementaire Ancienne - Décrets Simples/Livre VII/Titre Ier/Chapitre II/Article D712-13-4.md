Article D712-13-4
----
Lorsque la reconversion de lits et de places est autorisée, en application de
...
excédentaires par le nombre des lits ou places autorisés ;

3° Pour chaque discipline ou groupe de disciplines, la capacité susceptible
d'être autorisée dans le cadre de l'opération de reconversion est obtenue en
diminuant la capacité initiale autorisée d'un nombre de lits ou places égal au
produit de ladite capacité initiale par le taux d'excédent ;
...
faisant l'objet de la reconversion. Lorsque la somme (R) des réductions propres
à chaque discipline, calculée en application des 1°, 2° et 3° ci-dessus dépasse
le nombre P résultant de l'application du plafond, le nombre total des lits ou
places à supprimer est ramené à ce nombre P. A cet effet, la réduction propre à
chaque discipline est multipliée par un coefficient égal à :


PR

Lorsque le regroupement et la reconversion sont simultanés, les réductions de
