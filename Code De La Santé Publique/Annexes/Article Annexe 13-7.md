...
supérieure à un mégaélectronvolt (MeV).
...
parmi la population, sont plus particulièrement exposés à ladite source.
...
et son état énergétique nucléaire.
...
produire des ions directement ou indirectement.

Sievert : unité commune utilisée à la fois pour la dose équivalente, la dose
équivalente engagée, la dose efficace et la dose efficace engagée.
