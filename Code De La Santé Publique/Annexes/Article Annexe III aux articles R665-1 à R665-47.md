...
n'a été introduite auprès d'un autre organisme habilité.
...
schémas susmentionnés et le fonctionnement du produit ;
...
n'ont pas été appliquées entièrement ;

- les résultats des calculs de conception, de l'analyse des risques, des études,
des essais techniques, etc., qui ont été effectués ;
...
normes pertinentes, si celles-ci ont réellement été appliquées ;
...
sont annexées au certificat et une copie est conservée par l'organisme habilité.
...
au certificat initial d'examen CE de type.
...
les addenda délivrés, refusés et retirés ;
...
après information du fabricant ;
...
durée d'au moins cinq ans après la fabrication du dernier dispositif ;
