...
1.1. Nombre des logements locatifs par type de logements avec numéro des
logements.
...
1.5. Garages et parkings affectés à ces logements (nombre et différenciation par
type).
...
avec les normes minimales d'habitabilité définies par arrêté du ministre chargé
du logement, sauf en cas d'impératifs techniques tenant à la structure de
l'immeuble.

4.1. Date d'achèvement de la construction ou certificat de conformité.

4.2. Date à laquelle le bailleur s'engage à réaliser les travaux définis
ci-dessus :

ou/et dans le cas d'un programme de travaux prévoyant plusieurs tranches,
mention des différentes tranches et délai prévisible de réalisation : ....
