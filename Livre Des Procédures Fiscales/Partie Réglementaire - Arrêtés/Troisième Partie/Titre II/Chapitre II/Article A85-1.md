...
livres à la première demande des agents du service des douanes et droits
indirects chargés de percevoir l'impôt sur les spectacles. Ils doivent justifier
toutes les inscriptions portées sur ces documents ainsi que, d'une manière
générale, toutes les opérations effectuées.
