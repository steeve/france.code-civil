...
quatre échantillons doivent être, autant que possible, identiques.
...
d'exploitation ou le représentant de l'un d'eux est également présent.
...
représenté après avoir été convoqué, aucun prélèvement n'est réalisé.
...
étiquette d'identification portant les mentions suivantes :
