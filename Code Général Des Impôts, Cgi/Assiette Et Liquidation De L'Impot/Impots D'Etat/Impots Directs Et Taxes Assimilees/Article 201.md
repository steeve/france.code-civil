...
Lorsque la cession ou la cessation du fonds intervient moins de cinq ans
[*délai*] après la création ou l'acquisition de ce dernier, le bénéfice restant
à taxer est augmenté, le cas échéant, du montant des plus-values provenant de la
cession des stocks. Les plus-values provenant de la cession des éléments de
l'actif immobilisé sont imposées dans les conditions prévues aux articles 150 A
à 150 T.
...
l'appui de cette déclaration, toutes justifications utiles [*formalités
obligatoires*].
...
cet effet [*délai*], les bases d'imposition sont arrêtées d'office [*sanction*].
