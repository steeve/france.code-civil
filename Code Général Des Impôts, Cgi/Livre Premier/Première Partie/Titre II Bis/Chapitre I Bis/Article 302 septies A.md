...
n'excède pas ((3.800.000 F)) (1') , s'il s'agit d'entreprises dont le commerce
principal est de vendre des marchandises, objets, fournitures et denrées à
emporter ou à consommer sur place ou de fournir le logement, ou ((1.100.000 F))
(1'), s'il s'agit d'autres entreprises. Ces limites s'apprécient en faisant
...
exercice [*délai*]. Un décret en Conseil d'Etat (2) fixe les modalités
d'application pratique du présent paragraphe; il procède aux adaptations
