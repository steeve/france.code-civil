Article L325-1
----
Les capitaines de navire faisant escale dans un port maritime sont tenus, avant
de quitter le port, de déposer les déchets d'exploitation et résidus de
cargaison de leur navire dans les installations de réception flottantes, fixes
ou mobiles existantes.

Les officiers de port peuvent interdire la sortie du navire qui n'aurait pas
déposé ses déchets d'exploitation et résidus de cargaison dans une installation
de réception adéquate, et subordonner leur autorisation à l'exécution de cette
prescription.

Toutefois, s'il s'avère que le navire dispose d'une capacité de stockage
spécialisée suffisante pour tous les déchets d'exploitation qui ont été et
...
dépôt des déchets d'exploitation et résidus de cargaison.

Les frais d'immobilisation du navire résultant de ce contrôle sont à la charge
de l'armateur, du propriétaire ou de l'exploitant.
...
utilise exclusivement pour ses propres besoins.
...
internationale pour la mise en oeuvre de l'annexe V de cette convention ;
...
les excédents et quantités déversés lors du chargement ou du déchargement.
