...
ses caractéristiques physiques, par la formule ci-après :

V = L x b x Te

dans laquelle V est exprimée en mètres cubes, L, b, Te représentent
respectivement la longueur hors tout du navire, sa largeur maximale et son
tirant d'eau maximal d'été, et sont exprimés en mètres et décimètres.
...
établi selon la formule de l'alinéa 1er en prenant forfaitairement un tirant
d'eau égal à un mètre.
...
de soutage ou d'avitaillement ou de déchargement de déchets d'exploitation ou de
