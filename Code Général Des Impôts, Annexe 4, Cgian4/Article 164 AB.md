...
d'effectuer ou de tolérer que soient effectuées chez l'usager des réparations
ayant une répercussion sur le mécanisme des compteurs ou sur celui d'apposition
des empreintes ;

de modifier d'une façon quelconque une des parties du mécanisme des machines en
service.
