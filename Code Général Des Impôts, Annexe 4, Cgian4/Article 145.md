...
l'établissement permet de déterminer le chiffre des recettes dont il s'agit.

Le produit de la vente des billets d'entrée ne doit pas être confondu avec les
autres recettes de l'établissement qui toutes sans exception et de quelque
nature qu'elles soient doivent figurer sur le registre dont il est question
ci-dessus. Les opérations au comptant pour des valeurs inférieures à 0,10 F
peuvent être inscrites globalement à la fin de chaque journée. Le montant des
...
salles spéciales les opérations à inscrire sur le carnet visé au présent article
