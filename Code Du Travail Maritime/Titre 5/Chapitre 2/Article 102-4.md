...
moins d'embarquement effectif, et d'une ancienneté de services continus
inférieure à deux ans ;

A un délai-congé de deux mois s'il justifie chez le même armateur d'une
ancienneté de services continus d'au moins de deux ans.
...
ou d'embarquement effectif plus favorable pour le marin intéressé.
