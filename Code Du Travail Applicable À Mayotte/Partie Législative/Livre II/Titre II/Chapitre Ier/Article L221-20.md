...
municipal détermine les conditions dans lesquelles ce repos est accordé, soit
collectivement, soit par roulement dans une période qui ne peut excéder la
quinzaine qui précède ou suit la suppression du repos. Si le repos dominical est
supprimé un dimanche précédant une fête légale, le repos compensateur est donné
