...
près les tribunaux de grande instance de...), il est convenu ce qui suit :
...
l'autorité du maire de la commune du lieu d'intervention.
...
coopération intercommunale assurent la garde statique des bâtiments communaux.
...
d'infractions qu'elles assurent dans le cadre de leurs compétences.
...
à l'adaptation des dispositifs de chacun des services.
...
[ou des représentants] de l'Etat) :
...
de la sécurité sur le territoire de ces communes.
...
l'ordre public et qui a été observé dans l'exercice de leurs missions.
...
modalités d'engagement ou de mise à disposition (à préciser) ;
...
les informations utiles, notamment dans les domaines suivants (à préciser) ;
...
contrôle de son utilisation (à préciser) ;
...
des modalités concrètes d'engagement de ces missions (à préciser) ;
...
fourrière automobile (à préciser) ;
...
relations avec les partenaires, notamment les bailleurs (à préciser) ;

9° De l'encadrement des manifestations sur la voie publique ou dans l'espace
public, hors missions de maintien de l'ordre (à préciser).
...
au procureur (ou aux procureurs) de la République.
