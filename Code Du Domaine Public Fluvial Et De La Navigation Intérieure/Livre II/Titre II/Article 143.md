...
limite fixée par le permis de navigation ;

2° Les appareils prescrits soit pour limiter ou indiquer cette pression, soit
pour indiquer le niveau de l'eau dans l'intérieur des chaudières, soit pour
alimenter d'eau les chaudières, ont été faussés ou paralysés.
