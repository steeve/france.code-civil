...
l'exécution de ces tâches. La convention précise notamment le contenu des
missions confiées, les objectifs à atteindre, les modalités de rémunération des
prestataires, les modalités de paiement, les délais d'exécution, les clauses et
les moyens de contrôle et d'évaluation ainsi que les conditions de résolution
des litiges. Lorsque les tâches confiées sont l'agréage, le stockage, le tri et
le conditionnement, la convention garantit l'accès des producteurs adhérents à
l'organisation aux installations techniques du prestataire.

Dans tous les cas, cette convention est soumise au vote de l'assemblée générale
de l'organisation délégante.
