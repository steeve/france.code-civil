...
par l'Etat est déterminée en fonction du taux de la subvention calculée d'après
le barème en vigueur au ministère de l'agriculture pour les travaux
d'alimentation en eau potable, que cette subvention soit ou non accordée.

Le taux de cette participation est fixé comme suit :

Taux prévu pour le calcul de la subvention (en pourcentage), taux de la
