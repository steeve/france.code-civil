...
pouvoir être directement comparés à ceux de l'exercice sous revue.
...
qui en fait la demande et à l'Autorité de contrôle instituée par l'article L.
...
devise autre que le FF dans laquelle elles sont libellées
...
-A : provisions techniques spéciales des opérations visées à l'article L. 932-24
(France) ;
...
économique européenne hors France (art.R. 931-10-27) ;
...
et F du modèle de l'état détaillé et les lignes suivantes :
...
les placements et la part des réassureurs dans les provisions techniques)
...
globalement. c) Les institutions et les unions agréées pour la branche
mentionnée au 16 (a) de l'article R. 932-2-1 établissent pour ces opérations un
état des règlements et des provisions pour sinistres à payer inscrites à leur
bilan au titre de l'ensemble de ces opérations, présenté selon le modèle
ci-après.
...
autres institutions et unions), selon le modèle ci-dessous :
...
Total des autres produits des placements (plus-values, reprises sur
amortissements ou provisions...) inclus au poste E2 et/ou F3 du compte de
résultat :

Total des autres charges de placements (moins-values, dotations aux
...
ou sous-rubriques intitulées " charges de provisions " sont affectées du
signe-en cas de diminution des provisions ; la sous-rubrique " variation des
...
d'assurance vie à la clôture (poste B 3b du bilan) TOTAL b) Fournissent un
tableau récapitulatif des éléments constitutifs de la participation des
...
A. - Participation aux résultats totale (poste D6 et E7 du compte de résultat =
A1 + A2) :
...
(2) Demi-somme des provisions mathématiques à l'ouverture et à la clôture de
l'exercice, correspondant aux opérations visées au (4).

(3) Participation effective (charge de l'exercice, y compris intérêts
techniques) correspondant aux opérations visées au (4).

(4) Opérations individuelles et collectives souscrites sur le territoire de la
République française à l'exception des opérations collectives en cas de décès et
