...
servie proportionnellement au nombre de mois pendant lesquels le droit est
ouvert.

L'allocation de logement fait l'objet d'une liquidation unique pour chaque
exercice. Elle ne peut être révisée au cours de l'exercice que dans les cas
suivants :

1°) lorsque la composition de la famille est modifiée ;

2°) lorsque l'allocataire s'installe dans un nouveau logement, dans ce cas,
l'allocation est révisée soit sur la base du loyer principal effectivement payé
pour le premier mois de location du nouveau local, soit sur la base des
paiements incombant à l'allocataire en vue de l'accession à la propriété pour la
partie de la période restant à courir.
