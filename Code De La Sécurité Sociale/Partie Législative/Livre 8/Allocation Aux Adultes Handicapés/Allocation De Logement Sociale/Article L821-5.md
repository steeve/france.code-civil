...
caisse débitrice de l'allocation que celle-ci lui soit versée directement.
L'action de l'allocataire pour le paiement de l'allocation se prescrit par deux
ans [*délai de prescription*].
...
des dépenses versées au titre de l'allocation aux adultes handicapés.
