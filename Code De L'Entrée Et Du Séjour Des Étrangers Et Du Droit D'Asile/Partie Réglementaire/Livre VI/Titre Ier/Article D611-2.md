...
Les informations relatives à la profession sont limitées à celles qui sont
strictement nécessaires pour permettre l'application du présent code et des
conventions internationales y apportant dérogation ; à défaut, elles ne peuvent
être collectées que si la mention de leur caractère facultatif a été indiquée.
