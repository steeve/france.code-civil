...
a) Identité (nom, prénoms et sexe) et, s'il agit comme représentant d'une
personne morale, sa qualité ;

b) Date et lieu de naissance ;

c) Nationalité ;

d) Type et numéro de document d'identité, ainsi que sa date et son lieu de
délivrance si l'attestation d'accueil est signée par un ressortissant français ;

e) Type et numéro de titre de séjour, ainsi que sa date, son lieu de délivrance
et sa durée de validité si l'attestation d'accueil est signée par un
ressortissant étranger ;

f) Adresse ;

g) Données relatives à la situation financière, nécessaires pour apprécier la
capacité de prise en charge des frais de séjour et d'hébergement de l'étranger ;

h) Données relatives aux attestations d'accueil antérieurement signées par
l'hébergeant, s'il y a lieu (nombre, dates, identité de l'étranger) ;
...
a) Caractéristiques du logement (surface habitable, nombre de pièces habitables
et nombre d'occupants) ;
